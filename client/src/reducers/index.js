...
import { books, booksHasErrored, booksIsLoading, facets, selectedFacets } from './books'
...
const rootReducer = combineReducers({form: formReducer, ui: uiReducer, login, loginHasErrored, loginIsLoading, books, booksHasErrored, booksIsLoading, bookLists, bookListsHasErrored, bookListsIsLoading, facets, selectedFacets, routing: routerReducer });
