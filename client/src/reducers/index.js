...
import { books, booksHasErrored, booksIsLoading, facets } from './books'
...
const rootReducer = combineReducers({form: formReducer, ui: uiReducer, login, loginHasErrored, loginIsLoading, books, booksHasErrored, booksIsLoading, bookLists, bookListsHasErrored, bookListsIsLoading, facets, routing: routerReducer });
